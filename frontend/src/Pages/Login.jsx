  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-500 to-indigo-700">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        <h1 className="text-3xl font-bold text-center text-indigo-700 mb-6">Sign in to your account</h1>
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full py-2 px-4 bg-indigo-700 hover:bg-indigo-800 text-black font-semibold rounded-lg shadow-md transition duration-200"
          >
            Sign In
          </button>
        </form>
